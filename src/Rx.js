...
function getAssign(root$$1) {
    return Object.assign || assignImpl;
}
...
var ImmediateDefinition = (function () {
    ...
    ImmediateDefinition.prototype.runIfPresent = function (handle) {
        ...
        if (this.currentlyRunningATask) {
            ...
            setTimeout(this.partiallyApplied(this.runIfPresent, handle), 0);
        }
        else {
...
var RequestAnimationFrameDefinition = (function () {
    function RequestAnimationFrameDefinition(root$$1) {
        if (root$$1.requestAnimationFrame) {
            ...
            this.cancelAnimationFrame = clearTimeout.bind(root$$1);
            this.requestAnimationFrame = function (cb) { return setTimeout(cb, 1000 / 60); };
        }
    }
